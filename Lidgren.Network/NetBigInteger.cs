    ...
    internal class NetBigInteger
    {
            ...
            int length)
        {
            ...
            else
            {
                ...
                SignValue = m_magnitude.Length > 0 ? 1 : 0;
            }
        }
            ...
            int length)
        {
            ...
            else
            {
                // copy bytes
                m_magnitude = MakeMagnitude(bytes, offset, length);
                SignValue = m_magnitude.Length < 1 ? 0 : sign;
            }
        }
            ...
            int[] magToAdd)
        {
            ...
            return new NetBigInteger(SignValue, bigCopy, possibleOverflow);
        }
        ...
        {
            return SignValue > 0 && m_numBits == 1;
        }
            ...
            NetBigInteger value)
        {
            return SignValue < value.SignValue
                ...
                : SignValue > value.SignValue
                    ...
                    : SignValue == 0
                        ? 0
                        : SignValue*CompareNoLeadingZeroes(0, m_magnitude, 0, value.m_magnitude);
        }
            ...
            NetBigInteger val)
        {
            ...
            return new NetBigInteger(SignValue*val.SignValue, Divide(mag, val.m_magnitude), true);
        }
            ...
            NetBigInteger val)
        {
            ...
            else if (val.QuickPow2Check()) // val is power of two
            {
                ...
                biggies[1] = new NetBigInteger(SignValue, remainder, true);
            }
            else
            {
                ...
                biggies[0] = new NetBigInteger(SignValue*val.SignValue, quotient, true);
                biggies[1] = new NetBigInteger(SignValue, remainder, true);
            }
            ...
            object obj)
        {
            ...
            if (biggie.SignValue != SignValue || biggie.m_magnitude.Length != m_magnitude.Length)
                return false;
            ...
            NetBigInteger val)
        {
            ...
            return new NetBigInteger(SignValue*val.SignValue, res, true);
        }
        ...
        public NetBigInteger Negate()
        {
            ...
            return new NetBigInteger(-SignValue, m_magnitude, false);
        }
            ...
            NetBigInteger n)
        {
            ...
            if (n.m_magnitude.Length == 1)
            {
                ...
                if (val > 0)
                {
                    ...
                    return rem == 0
                        ? Zero
                        : new NetBigInteger(SignValue, new[] {rem}, false);
                }
            }
            ...
            return new NetBigInteger(SignValue, result, true);
        }
        ...
        public NetBigInteger ShiftLeft(
            int n)
        {
            if (SignValue == 0 || m_magnitude.Length == 0)
                return Zero;
            ...
            var result = new NetBigInteger(SignValue, ShiftLeft(m_magnitude, n), true);

            if (m_numBits != -1)
            {
                result.m_numBits = SignValue > 0
                    ? m_numBits
                    : m_numBits + n;
            }
            ...
            int n)
        {
            ...
            return new NetBigInteger(SignValue, res, false);
        }
            ...
            NetBigInteger n)
        {
            ...
            return new NetBigInteger(SignValue*compare, doSubBigLil(bigun.m_magnitude, lilun.m_magnitude), true);
        }
