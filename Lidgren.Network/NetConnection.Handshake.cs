...
namespace Lidgren.Network
{
    public partial class NetConnection
    {
        ...
        internal void SendConnectResponse(double now, bool onLibraryThread)
        {
            ...
            var om =
                m_peer.CreateMessage(m_peerConfiguration.AppIdentifier.Length + 13 +
            ...
            if (onLibraryThread)
                ...
                m_peer.m_unsentUnconnectedMessages.Enqueue(
                    new NetTuple<NetEndPoint, NetOutgoingMessage>(m_remoteEndPoint, om));
        ...
        private void WriteLocalHail(NetOutgoingMessage om)
        {
            if (m_localHailMessage != null)
            {
                ...
                {
                    if (om.LengthBytes + m_localHailMessage.LengthBytes >
                        m_peerConfiguration.m_maximumTransmissionUnit - 10)
                        m_peer.ThrowOrLog("Hail message too large; can maximally be " +
        ...
        public void Approve()
        {
            ...
            {
                m_peer.LogWarning("Approve() called in wrong status; expected RespondedAwaitingApproval; got " +
                                  m_status);
                return;
            }
        ...
        /// </summary>
        /// <param name="reason">
        ///     The stated reason for the disconnect, readable as a string in the StatusChanged message on the
        ///     remote host
        /// </param>
