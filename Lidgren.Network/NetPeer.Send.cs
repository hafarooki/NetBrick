...
namespace Lidgren.Network
{
    public partial class NetPeer
    {
            ...
            int sequenceChannel)
        {
            ...
            var suppressFragmentation = (method == NetDeliveryMethod.Unreliable ||
                                         method == NetDeliveryMethod.UnreliableSequenced) &&
                                        m_configuration.UnreliableSizeBehaviour !=
                                        NetUnreliableSizeBehaviour.NormalFragmentation;

            var len = NetConstants.UnfragmentedMessageHeaderSize + msg.LengthBytes;
    ...
    // we don't have access to the particular peer, so just use default MTU
        ...
        public void SendUnconnectedMessage(NetOutgoingMessage msg, string host, int port)
        {
            ...
            Interlocked.Increment(ref msg.m_recyclingCount);
            m_unsentUnconnectedMessages.Enqueue(new NetTuple<NetEndPoint, NetOutgoingMessage>(
                new NetEndPoint(adr, port), msg));
        }
        ...
        public void SendUnconnectedToSelf(NetOutgoingMessage om)
        {
            ...
            im.m_senderEndPoint = Socket.LocalEndPoint as NetEndPoint;
