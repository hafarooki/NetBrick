namespace Lidgren.Network
{
    public partial class NetConnection
    {
        ...
        /// <summary>
        ///     Gets the current MTU in bytes. If PeerConfiguration.AutoExpandMTU is false, this will be
        ///     PeerConfiguration.MaximumTransmissionUnit.
        /// </summary>
        public int CurrentMTU
        {
            get { return m_currentMTU; }
        }
