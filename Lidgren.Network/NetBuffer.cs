...
namespace Lidgren.Network
{
    public partial class NetBuffer
    {
        ...
        /// <summary>
        ///     Gets the position in the buffer in bytes; note that the bits of the first returned byte may already have been read
        ///     - check the Position property to make sure.
        /// </summary>
