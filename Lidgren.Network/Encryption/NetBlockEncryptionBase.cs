...
namespace Lidgren.Network
{
    ...
    public abstract class NetBlockEncryptionBase : NetEncryption
    {
        ...
        /// <summary>
        ///     Encrypt am outgoing message with this algorithm; no writing can be done to the message after encryption, or message
        ///     will be corrupted
        /// </summary>
        public override bool Encrypt(NetOutgoingMessage msg)
        {
            ...
            var numBlocks = (int) Math.Ceiling(numBytes/(double) blockSize);
