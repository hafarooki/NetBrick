...
namespace Lidgren.Network
{
    ...
    public partial class NetPeer
    {
        ...
        /// <summary>
        ///     Gets a unique identifier for this NetPeer based on Mac address and ip/port. Note! Not available until Start() has
        ///     been called!
        /// </summary>
                ...
                if (m_handshakes.TryGetValue(remoteEndPoint, out hs))
                {
                    ...
                    switch (hs.m_status)
                    {
                        ...
                        default:
                            // weird
                            LogWarning(
                                "Weird situation; Connect() already in progress to remote endpoint; but hs status is " +
                                hs.m_status);
                            break;
                    }
                    return hs;
