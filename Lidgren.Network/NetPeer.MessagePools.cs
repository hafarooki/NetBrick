...
namespace Lidgren.Network
{
    public partial class NetPeer
    {
        ...
        public NetOutgoingMessage CreateMessage(int initialCapacity)
        {
            ...
            NetException.Assert(retval.m_recyclingCount == 0,
                "Wrong recycling count! Should be zero" + retval.m_recyclingCount);
        ...
        public void Recycle(NetIncomingMessage msg)
        {
            ...
            NetException.Assert(m_incomingMessagesPool.Contains(msg) == false,
                "Recyling already recycled incoming message! Thread race?");
        ...
        internal void Recycle(NetOutgoingMessage msg)
        {
            if (m_outgoingMessagesPool == null)
                return;
#if DEBUG
            NetException.Assert(m_outgoingMessagesPool.Contains(msg) == false,
                "Recyling already recycled outgoing message! Thread race?");
